...
window.onload = (0,_app__WEBPACK_IMPORTED_MODULE_0__.weather)("Los Angeles, US", units);
...
const events = (() => {
  document.getElementById("search").addEventListener("keydown", (event) => {
    if (event.key === "Enter") {
      (0,_app__WEBPACK_IMPORTED_MODULE_0__.weather)(event.target.value, units);
      event.target.value = "";
    }
  })
