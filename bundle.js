...
async function weather(city, units = "imperial") {
  ...
  if (data !== "ERROR") {
    ...
    return (0,_app__WEBPACK_IMPORTED_MODULE_0__["default"])(allWeather);
  }
  return (0,_app__WEBPACK_IMPORTED_MODULE_0__["default"])("Location Not Found");
}
