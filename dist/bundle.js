...
function appendData(data) {
  ...
  if (typeof weatherData === "object") {
    const currentWeather = (() => {
      ...
      document.getElementById("sunrise").textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(
        new Date(weatherData.current.sunrise_time * 1000),
        "h:m a"
      );

      document.getElementById("sunset").textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(
